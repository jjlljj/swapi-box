...
describe('getPeople', ()=> {
  ...
  describe('getPeopleData', () => {
    ...
    it('should catch errors', async () => {
      ...
      const peopleResult = getPeopleData(peopleArray)
      const expected = Error('Failed to get world data')
...
describe('getPlanets', () => {
  ...
  describe('getResidents', () => {
    ...
    it('should catch errors', () => {
      ...
      expect(residentResult).rejects.toEqual(expected)
    })
  })
  ...
  describe('getPlanets', () => {
    ...
    it('should catch errors', () => {
      window.fetch = jest.fn().mockImplementation(() => Promise.response({
        status: 500
      }))
      ...
      expect(planetsResponse).rejects.toEqual(expected)
    })
  })
})
